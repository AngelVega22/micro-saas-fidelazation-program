...
const CardList = ({ UserPrograms, filterValue }: CardListProps) => {
    ...
    const filteredPrograms = UserPrograms.filter((userProgram) => {
        if (filterValue === "isActive") {
            return userProgram.isActive && !userProgram.isDeleted && !userProgram.isExpired;
        ...
        } else if (filterValue === "isExpired") {
            return userProgram.isExpired;
        } else {
            return userProgram;
        }
    });
    ...
    return (<>
        {filteredPrograms.length > 0 ? (
                                                ...
                                                <div className="pl-5 flex flex-col items-start">
                                                    ...
                                                    <div className="flex flex-wrap gap-10 justify-between mt-1">
                                                        <div className="text-sm mt-1">
                                                            {userProgram.isActive && !userProgram.isDeleted && !userProgram.isExpired ? (
            ...
            <div className='mt-16 flex flex-col items-center gap-2'>
                ...
                <p className="text-center">¡Estamos preparando programas increíbles! Mantente atento y sé el primero en inscribirte cuando estén disponibles.</p>
            </div>
        )}
